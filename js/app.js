...
(function () {
  ...
  var i18n = {
    en: {
      ...
      "hero.title": "Property investment in Dubai, handled with precision",
      "hero.lead":
        "A licensed brokerage for investors and families seeking carefully selected off-plan and ready homes across Dubai's most established communities.",
      "hero.cta1": "View properties",
      "hero.cta2": "Speak on WhatsApp",
      "hero.s1": "500+",
      ...
      "form.private": "Private desk",
      "form.title": "Request a private briefing",
      "form.sub": "Share a few details. A senior advisor responds within the hour.",
      "form.name": "Full name",
      "form.phone": "Phone / WhatsApp",
      "form.email": "Email",
      "form.budget": "Budget",
      "form.interest": "Interest",
      "form.submit": "Request briefing",
    ...
    ar: {
      ...
      "hero.title": "استثمار عقاري في دبي بدقة واحتراف",
      "hero.lead":
        "وساطة مرخّصة للمستثمرين والعائلات الباحثين عن عقارات مختارة على الخارطة وجاهزة في أرقى مجتمعات دبي.",
      "hero.cta1": "عرض العقارات",
      "hero.cta2": "تواصل واتساب",
      "hero.s1": "+500",
      ...
      "form.private": "مكتب خاص",
      "form.title": "اطلب إحاطة خاصة",
      "form.sub": "شارك بعض التفاصيل. يرد مستشار أول خلال الساعة.",
      "form.name": "الاسم الكامل",
      "form.phone": "الهاتف / واتساب",
      "form.email": "البريد",
      "form.budget": "الميزانية",
      "form.interest": "الاهتمام",
      "form.submit": "اطلب الإحاطة",
  ...
  (function () {
    ...
    document.querySelectorAll(".nav a, .mobile-nav a, .footer-col a").forEach(function (a) {
      ...
      if (file === path || (path === "index.html" && (file === "" || file === "index.html" || file === "./"))) {

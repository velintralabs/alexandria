...
(function () {
  ...
  var i18n = {
    en: {
      ...
      "hero.kicker": "RERA Licensed · DLD #69664",
      "hero.title": "Your next Dubai address. Chosen with precision.",
      "hero.lead": "RERA-licensed advisors. Exclusive off-plan and ready homes. Clear numbers, private guidance, and deals structured around your goals.",
      "hero.cta1": "Explore listings",
      "hero.cta2": "WhatsApp an advisor",
      ...
      "hero.s1": "500+",
      "hero.s1l": "Transactions guided",
      "hero.s2": "AED 1.2B+",
      "hero.s2l": "Client portfolio value",
      "hero.s3": "15 min",
      "hero.s3l": "Average response time",
      "form.private": "Instant matching",
      "form.title": "Get matched in 15 minutes",
      "form.sub": "Tell us your budget and goal. A senior advisor replies on WhatsApp with tailored options.",
      "form.name": "Full name",
      ...
      "trust.1t": "RERA licensed",
      "trust.1s": "Dubai Land Department #69664",
      "trust.2t": "Bilingual advisors",
      "trust.2s": "Arabic and English throughout",
      "trust.3t": "Developer access",
      "trust.3s": "Emaar, DAMAC, Nakheel and more",
      "trust.4t": "End-to-end care",
      "trust.4s": "From first viewing to handover",
      "prop.eye": "Selected inventory",
      "prop.title": "Properties chosen for return and residency value",
      "prop.lead": "A short list of opportunities across Dubai's highest-demand districts.",
      "prop.all": "All",
      ...
      "svc.eye": "Capabilities",
      "svc.title": "What we handle for you",
      "svc.lead": "Clear mandates. Measured advice. Full execution.",
      "svc.1t": "Off-plan investment",
      "svc.1d": "Early access to launches, payment structures, and capital-growth opportunities with verified developers.",
      "svc.2t": "Ready homes",
      "svc.2d": "Move-in residences in established communities with transparent rental and resale comparables.",
      "svc.3t": "Investment advisory",
      "svc.3d": "Market briefings, yield modelling, and portfolio decisions aligned to your horizon and risk.",
      "svc.4t": "Property management",
      "svc.4d": "Leasing, tenant care, maintenance coordination, and owner reporting after purchase.",
      "svc.5t": "Golden Visa pathway",
      "svc.5d": "Eligibility review, documentation, and coordination for residency through property investment.",
      "svc.6t": "After-sales support",
      "svc.6d": "DLD registration, NOC, snagging, and handover managed carefully after the contract is signed.",
      "proc.eye": "Process",
      ...
      "cta.title": "Ready to discuss Dubai with clarity?",
      "cta.lead": "A complimentary 15-minute consultation. No obligation — only a clear next step.",
      "cta.1": "Book a call",
      "cta.2": "WhatsApp",
      "con.eye": "Contact",
      ...
      "wa.msg": "Hello Alexandria RE. I visited your website regarding Dubai real estate.",
      "hero.s4": "30+",
      "hero.s4l": "Nationalities Served",
      "hero.s5": "12+",
      "hero.s5l": "Years of Experience",
      "lifestyle.eye": "The Dubai Lifestyle",
      "lifestyle.title": "Live Where the World Aspires to Be.",
      "lifestyle.lead": "Year-round sunshine, world-class dining, pristine beaches, and a cosmopolitan community from over 200 nationalities.",
      "community.eye": "Community Focus",
      "community.title": "World-Class Communities.",
      "community.lead": "From Dubai Marina's waterfront living to Dubai Hills' family-friendly suburbs — every community offers a distinct lifestyle and investment profile.",
      "proc.5t": "Ongoing Support",
      "proc.5d": "Leasing, management, and portfolio growth — long after handover.",
      "proc.1desc": "We begin with a private consultation to understand exactly what you're looking for — whether it's an investment property, a family home, or a Golden Visa-eligible unit. No pressure, just clarity.",
      "proc.2desc": "We present a curated shortlist with transparent data — rental yields, capital appreciation trends, developer track records, and payment plan comparisons side by side.",
      "proc.3desc": "Whether you're in Dubai or abroad, we arrange immersive virtual tours or in-person visits. Every property is presented with honest context — the strengths and the trade-offs.",
      "proc.4desc": "From SPA review to Dubai Land Department registration, escrow coordination, and final handover — we manage every document and deadline so nothing falls through the cracks.",
      "proc.5desc": "Your relationship with Alexandria doesn't end at the handover. We offer property management, tenant placement, resale advisory, and ongoing portfolio reviews as your investment grows.",
      "interiors.eye1": "Luxury Living Spaces",
      "interiors.desc1": "From penthouse apartments overlooking the Marina to sprawling villas on Palm Jumeirah.",
      "interiors.eye2": "Curated Interiors",
      "interiors.desc2": "Every property hand-selected for quality, location, and long-term value.",
      "team.heading": "People You Can Trust With Your Decision",
      "team.readMore": "Read More",
      "agents.4n": "Ahmed Khaled",
      "agents.4r": "Investment Director",
      "insights.eye": "Knowledge Centre",
      "insights.title": "Make Informed Decisions",
      "insights.viewAll": "View All",
      "insights.1cat": "Buying Guide",
      "insights.1t": "Buying Property in Dubai as a Foreigner",
      "insights.1d": "Freehold ownership, designated areas, and the legal framework explained.",
      "insights.2cat": "Investment Strategy",
      "insights.2t": "Understanding Off-Plan Investments",
      "insights.2d": "Payment structures, developer track records, and how to evaluate objectively.",
      "insights.3cat": "Residency",
      "insights.3t": "Golden Visa Through Property Investment",
      "insights.3d": "Eligibility, documentation, timelines, and purchase structuring.",
      "wa.float": "Speak with a Dubai Property Advisor",
      "foot.licensed": "Licensed Real Estate Broker · Dubai Land Department"
    },
    ar: {
      "nav.home": "الرئيسية",
      ...
      "hero.kicker": "مرخّص من ريرا · دائرة الأراضي #69664",
      "hero.title": "عنوانك القادم في دبي. باختيار دقيق.",
      "hero.lead": "مستشارون مرخّصون من ريرا. عقارات حصرية على الخارطة وجاهزة. أرقام واضحة وتوجيه خاص وصفقات تُبنى حول أهدافك.",
      "hero.cta1": "استكشف العقارات",
      "hero.cta2": "واتساب مع مستشار",
      ...
      "trust.1t": "مرخّص من ريرا",
      "trust.1s": "دائرة الأراضي #69664",
      "trust.2t": "مستشارون ثنائيو اللغة",
      "trust.2s": "العربية والإنجليزية",
      "trust.3t": "وصول للمطورين",
      "trust.3s": "إعمار وداماك ونخيل والمزيد",
      "trust.4t": "رعاية متكاملة",
      "trust.4s": "من أول معاينة حتى التسليم",
      ...
      "svc.eye": "القدرات",
      "svc.title": "ما نتولاه عنك",
      "svc.lead": "مهام واضحة. نصيحة مدروسة. تنفيذ كامل.",
      ...
      "cta.title": "جاهز لمناقشة دبي بوضوح؟",
      "cta.lead": "استشارة مجانية لمدة 15 دقيقة. بلا التزام — فقط خطوة تالية واضحة.",
      "cta.1": "احجز مكالمة",
      "cta.2": "واتساب",
      "con.eye": "تواصل",
      ...
      "wa.msg": "مرحباً الإسكندرية للعقارات. زرت موقعكم بخصوص عقارات دبي.",
      "hero.s4": "+30",
      "hero.s4l": "جنسية تم خدمتها",
      "hero.s5": "+12",
      "hero.s5l": "سنوات من الخبرة",
      "lifestyle.eye": "أسلوب الحياة في دبي",
      "lifestyle.title": "عِش حيث يتطلع العالم أن يكون.",
      "lifestyle.lead": "أشعة الشمس طوال العام، مطاعم عالمية، شواطئ نقية، ومجتمع عالمي من أكثر من 200 جنسية.",
      "community.eye": "التركيز على المجتمعات",
      "community.title": "مجتمعات عالمية المستوى.",
      "community.lead": "من الواجهة البحرية لمارينا إلى ضواحي دبي هيلز العائلية — كل مجتمع يقدم أسلوب حياة وملف استثماري مميز.",
      "proc.5t": "الدعم المستمر",
      "proc.5d": "التأجير والإدارة ونمو المحفظة — بعد التسليم بفترة طويلة.",
      "proc.1desc": "نبدأ باستشارة خاصة لفهم ما تبحث عنه بالضبط — سواء كان عقاراً استثمارياً، أو منزلاً عائلياً، أو وحدة مؤهلة للتأشيرة الذهبية. بلا ضغط، فقط وضوح.",
      "proc.2desc": "نقدم قائمة مختارة مع بيانات شفافة — عوائد الإيجار، واتجاهات appreciation رأس المال، وسجلات المطورين، ومقارنة خطط السداد جنباً إلى جنب.",
      "proc.3desc": "سواء كنت في دبي أو بالخارج، نرتب جولات افتراضية غامرة أو زيارات ميدانية. كل عقار يُعرض مع سياق صادق — نقاط القوة والمزايا والعيوب.",
      "proc.4desc": "من مراجعة عقد البيع إلى التسجيل في دائرة الأراضي، والتنسيق مع الحساب الضمان، والتسليم النهائي — ندير كل وثيقة وكل موعد حتى لا يفوتك شيء.",
      "proc.5desc": "علاقتك بالإسكندرية لا تنتهي عند التسليم. نقدم إدارة عقارات، وتأجير، واستشارات إعادة البيع، ومراجعات محفظة مستمرة مع نمو استثمارك.",
      "interiors.eye1": "مساحات معيشة فاخرة",
      "interiors.desc1": "من شقق البنتهاوس المطلة على المارينا إلى الفلل الواسعة في نخلة جميرا.",
      "interiors.eye2": "تصميمات داخلية مختارة",
      "interiors.desc2": "كل عقار مختار بعناية من حيث الجودة والموقع والقيمة طويلة الأجل.",
      "team.heading": "أشخاص يمكنك الوثوق بهم بقرارك",
      "team.readMore": "اقرأ المزيد",
      "agents.4n": "أحمد خالد",
      "agents.4r": "مدير الاستثمار",
      "insights.eye": "مركز المعرفة",
      "insights.title": "اتخذ قرارات مدروسة",
      "insights.viewAll": "عرض الكل",
      "insights.1cat": "دليل الشراء",
      "insights.1t": "شراء العقارات في دبي كأجنبي",
      "insights.1d": "التملك الحر، المناطق المحددة، والإطار القانوني موضحاً.",
      "insights.2cat": "استراتيجية الاستثمار",
      "insights.2t": "فهم استثمارات على الخارطة",
      "insights.2d": "خطط السداد، سجلات المطورين، وكيفية التقييم الموضوعي.",
      "insights.3cat": "الإقامة",
      "insights.3t": "التأشيرة الذهبية عبر الاستثمار العقاري",
      "insights.3d": "الأهلية والوثائق والجداول الزمنية وتنظيم عملية الشراء.",
      "wa.float": "تحدث مع مستشار عقارات في دبي",
      "foot.licensed": "وساطة عقارية مرخّصة · دائرة الأراضي بدبي"
    }
  };
